            ...
            <a href="{{ route('frontend.tours.show', $tour->slug) }}" class="text-decoration-none h-100 d-block">
                <div class="premium-card">
                    <div class="card-img-wrapper">
                        <span class="badge-glass"><i class="bi bi-clock me-1"></i>{{ $tour->duration_days }}N{{ $tour->duration_nights }}Đ</span>
                        @php
...
<section class="container py-5 mb-5 reveal-up">
    ...
    <div class="row g-4">
        ...
        <div class="col-12 col-md-6 col-lg-3">
            <div class="premium-card">
                <div class="card-img-wrapper">
                    <span class="badge-glass"><i class="bi bi-star-fill text-warning me-1"></i>Hot</span>
                    <img src="https://images.unsplash.com/photo-1513889961551-628c1e5e2ee9?q=80&w=800" class="card-img-top" alt="{{ $ticket->title }}">
                </div>
                <div class="card-body">
