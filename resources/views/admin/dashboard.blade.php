...
@section('content')
    <div class="row g-4 mb-4">
        ...
        <div class="col-xl-3 col-md-6">
            <div class="admin-card h-100 border-0"
                style="background: linear-gradient(135deg, var(--admin-primary) 0%, #3b82f6 100%); color: white;">
                <div class="admin-card-body d-flex align-items-center justify-content-between">
                    <div>
                        <h6 class="text-white-50 text-uppercase fw-600 mb-2"
                            style="font-size: 0.8rem; letter-spacing: 0.5px;">Tổng Doanh Thu</h6>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="admin-card h-100 border-0"
                ...
                <div class="admin-card-body d-flex align-items-center justify-content-between">
                    <div>
                        <h6 class="text-white-50 text-uppercase fw-600 mb-2"
                            style="font-size: 0.8rem; letter-spacing: 0.5px;">Tổng Đơn Đặt Chỗ</h6>
                ...
                <div class="px-4 py-2 bg-black bg-opacity-10" style="font-size: 0.8rem;">
                    <a href="{{ route('admin.bookings.index') }}" class="text-white text-decoration-none">Xem chi tiết <i
        ...
        <div class="col-xl-3 col-md-6">
            <div class="admin-card h-100 border-0"
                ...
                <div class="admin-card-body d-flex align-items-center justify-content-between">
                    <div>
                        <h6 class="text-white-50 text-uppercase fw-600 mb-2"
                            style="font-size: 0.8rem; letter-spacing: 0.5px;">Sản Phẩm Tour</h6>
                ...
                <div class="px-4 py-2 bg-black bg-opacity-10" style="font-size: 0.8rem;">
                    <a href="{{ route('admin.tours.index') }}" class="text-white text-decoration-none">Quản lý Tour <i
                            class="bi bi-arrow-right ms-1"></i></a>
                </div>
            </div>
        </div>
        ...
        <div class="col-xl-3 col-md-6">
            <div class="admin-card h-100 border-0"
                ...
                <div class="admin-card-body d-flex align-items-center justify-content-between">
                    <div>
                        <h6 class="text-white-50 text-uppercase fw-600 mb-2"
                            style="font-size: 0.8rem; letter-spacing: 0.5px;">Khách Hàng</h6>
        ...
        <div class="row g-4">
            ...
            <div class="col-lg-8">
                <div class="admin-card h-100">
                    <div class="admin-card-header">
                        <h5 class="admin-card-title"><i class="bi bi-compass me-2 text-primary"></i>Các tour đang diễn ra
                        </h5>
                        <a href="{{ route('admin.ongoing_tours.index') }}" class="btn btn-sm btn-light border">Xem tất
                            cả</a>
                    </div>
                        ...
                        <div class="table-responsive">
                            <table class="table table-hover align-middle mb-0">
                                ...
                                <tbody>
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <small class="text-muted">Mã:
                                                    #{{ str_pad($schedule->id, 5, '0', STR_PAD_LEFT) }}</small>
                                            </td>
                                            <td>
                                                ...
                                                <small class="text-muted">Đến
                                                    {{ \Carbon\Carbon::parse($schedule->return_date)->format('d/m/Y') }}</small>
                                            </td>
                                            <td>
                                                @php
                                                ...
                                                @if($schedule->schedule_guides->count() > 0)
                                                    <div class="d-flex flex-wrap gap-1">
                                                        @foreach($schedule->schedule_guides as $sg)
                                                            <span
                                                                class="badge bg-info bg-opacity-10 text-info border border-info rounded-pill px-2 py-1">
                                                                <i
                                                                    class="bi bi-person-fill me-1"></i>{{ $sg->tour_guide->name ?? 'N/A' }}
                                                            </span>
                                                        @endforeach
                                                    </div>
                                                @else
                                    ...
                                    @empty
                                        <tr>
                                            <td colspan="4" class="text-center py-4 text-muted">Không có tour nào đang diễn ra
                                                hôm
                                                nay.</td>
                                        </tr>
                                    @endforelse
            ...
            <div class="col-lg-4">
                <div class="admin-card h-100">
                    <div class="admin-card-header">
                        <h5 class="admin-card-title"><i class="bi bi-pie-chart me-2 text-primary"></i>Tổng quan Đơn đặt chỗ
                        </h5>
                    </div>
