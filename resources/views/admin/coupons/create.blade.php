            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="text" name="code" class="form-control @error('code') is-invalid @enderror"
                        value="{{ old('code') }}" placeholder="VD: SALE25" maxlength="30"
                        style="text-transform: uppercase">
                    @error('code')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                    <small class="text-muted">Chỉ chứa chữ in hoa (A-Z), số (0-9) và dấu gạch dưới (_). Từ 3 đến 30 ký tự.</small>
                </div>
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="discount_value" id="discount_value"
                        ...
                        value="{{ old('discount_value') }}" placeholder="VD: 25 hoặc 100000"
                        step="0.01" min="0.01">
                ...
                <div class="col-md-6 mb-3">
                    ...
                    <input type="number" name="min_order_value"
                        ...
                        value="{{ old('min_order_value') }}" placeholder="VD: 500000"
                        step="1000" min="0">
            ...
            <div class="row">
                <div class="col-md-6 mb-3">
                    ...
                    <input type="date" name="valid_from" id="valid_from"
                        ...
                        value="{{ old('valid_from') }}" min="{{ date('Y-m-d') }}">
                    @error('valid_from')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
