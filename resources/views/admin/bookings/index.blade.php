        ...
        <div class="modal-content border-0 shadow">
            ...
            <form action="{{ route('admin.bookings.update_status', $booking->id) }}" method="POST">
                ...
                <div class="modal-body p-4">
                    ...
                    <div class="mb-3">
                        <label class="form-label fw-bold">Trạng thái Đơn (Booking)</label>
                        <select name="booking_status" class="form-select">
                            <option value="pending" {{ $booking->booking_status == 'pending' ? 'selected' : '' }}>Chờ xác nhận</option>
                            <option value="confirmed" {{ $booking->booking_status == 'confirmed' ? 'selected' : '' }}>Đã xác nhận</option>
                            <option value="paid" {{ $booking->booking_status == 'paid' ? 'selected' : '' }}>Đã thanh toán</option>
