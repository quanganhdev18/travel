                ...
                <form action="{{ route('admin.holidays.update', $holiday->id) }}" method="POST">
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="date" name="start_date" class="form-control" value="{{ \Carbon\Carbon::parse($holiday->start_date)->format('Y-m-d') }}" required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label class="form-label fw-bold">Ngày kết thúc <span class="text-danger">*</span></label>
                            <input type="date" name="end_date" class="form-control" value="{{ \Carbon\Carbon::parse($holiday->end_date)->format('Y-m-d') }}" required>
                        </div>
                    </div>
