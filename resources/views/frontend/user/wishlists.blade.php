...
@section('content')
    <style>
        ...
        .btn-view-tour {
            ...
            text-decoration: none;
            transition: all 0.3s ease;
            box-shadow: 0 4px 14px rgba(0, 124, 232, 0.3);
        }

        .btn-view-tour:hover {
            transform: translateY(-2px);
            box-shadow: 0 8px 20px rgba(0, 124, 232, 0.4);
            color: white;
        }
            ...
            <div class="container" style="position:relative;z-index:2;">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-2" style="--bs-breadcrumb-divider-color:rgba(255,255,255,0.5);">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('user.profile') }}"
                                class="text-white-50 text-decoration-none">Tài khoản</a></li>
                        <li class="breadcrumb-item text-white active">Yêu thích</li>
                    </ol>
                </nav>
                <h1 class="fw-800 mb-1" style="color:white;font-size:2rem;"><i class="bi bi-heart-fill me-2"
                        style="color:#ef4444;"></i>Tour yêu thích</h1>
            ...
            <div class="row g-4">
                ...
                <div class="col-lg-3">
                    <div class="profile-avatar-section reveal-up">
                        ...
                        <div class="joined-chip mb-4"><i class="bi bi-calendar3"></i> Tham gia
                ...
                <div class="col-lg-9">
                    ...
                    <div class="content-header reveal-up">
                        <div class="d-flex align-items-center gap-3">
                            <div
                                style="width:44px;height:44px;border-radius:14px;background:linear-gradient(135deg,#ef4444,#dc2626);display:flex;align-items:center;justify-content:center;color:white;font-size:1.2rem;box-shadow:0 6px 16px rgba(239,68,68,0.3);">
                        ...
                        @if($wishlists->isNotEmpty())
                            <a href="{{ url('/') }}" class="btn-view-tour"
                                    ...
                                    <div class="wish-card">
                                        ...
                                        <div class="wish-body">
                                            <div class="d-flex flex-wrap gap-2 mb-2">
                                                @if($t?->destination)
                                                    <span class="dest-chip"><i
                                                            class="bi bi-geo-alt-fill"></i>{{ $t->destination->name }}</span>
                                                @endif
                                                @if($t)
                                                    <span class="duration-chip"><i class="bi bi-clock"></i>{{ $t->duration_days }}
                                                        ngày</span>
                                                @endif
                                            </div>
                                            ...
                                            <div class="d-flex justify-content-between align-items-center">
                                                <div>
                                                    <div
                                                        style="font-size:0.72rem;color:#9ca3af;font-weight:600;text-transform:uppercase;letter-spacing:0.5px;">
                                                        Từ</div>
                                                    <div class="wish-price">{{ number_format($t?->base_price ?? 0, 0, ',', '.') }}₫
                                                    </div>
                                                </div>
                                                @if($t)
