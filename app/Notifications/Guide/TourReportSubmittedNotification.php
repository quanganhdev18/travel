...
class TourReportSubmittedNotification extends Notification
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            'type' => 'tour_report_submitted',
            'title' => 'Đã nộp báo cáo Tour',
            'message' => "Báo cáo cho tour \"{$tourTitle}\" đã được gửi và đang chờ Admin duyệt.",
