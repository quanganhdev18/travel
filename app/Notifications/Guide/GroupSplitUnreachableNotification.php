...
class GroupSplitUnreachableNotification extends Notification
{
    use Queueable;
    ...
    public function toArray(object $notifiable): array
    {
        ...
        return [
            'type' => 'group_split_unreachable',
            'title' => 'Hành khách mất liên lạc',
            'message' => "Hành khách \"{$guestName}\" trong tour \"{$tourCode}\" đã quá giờ tách đoàn 60 phút (Mất liên lạc).",
